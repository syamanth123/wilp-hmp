      ...
      <div className="mb-5 flex items-end justify-between">
        <div>
          ...
          <p style={{ color: 'var(--muted)', marginTop: 4, fontSize: 14 }}>
            System health, user management, and configuration.
          </p>
        </div>
        <Link href="/admin/users" className="bits-btn bits-btn-primary text-sm">
          Manage users
        </Link>
      </div>
              ...
              <div key={r.id} className="activity-row">
                ...
                <div className="row-body">
                  ...
                  <div className="row-meta">
                    {r.actor?.name ?? r.actor?.email ?? '—'} · {r.entity}
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <div className="glass-panel overflow-hidden rounded-[10px]">
          ...
          <div className="panel-body grid grid-cols-2 gap-3">
            ...
            <Link href="/admin/corpus-imports" className="quick-action">
              <span className="qa-icon">
                <FileIcon />
              </span>
              Corpus imports
