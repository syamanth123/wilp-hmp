...
Items 3, 6, and 7 are corrections to this very document and were folded in during the docs-honesty pass that landed alongside this audit (see `docs: honest README + RFP traceability + audit corrections`). Items 1, 2, 4, 5 are real code work; 4 is the largest (a from-scratch upload feature).
